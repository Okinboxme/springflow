...
4. Writes generated files under `springflow/generated/...`, preserving
   ...
   ```
5. Copies generated files into the React project at
   `springflow-react/src/springflow/generated` (the copy target is a
   hard-coded path in `SpringFlowProcessor`).
...
The generated clients live under `src/springflow/generated/...` and are
imported like any other TypeScript module:
...
| --- | --- |
| `name` | Project name. |
| `springflow` | SpringFlow version used by the project. |
| `frontend` | Frontend directory (default `frontend`). |
| `generated` | Where generated TypeScript files are placed. |
...
- The React copy path in `SpringFlowProcessor` is currently a
  hard-coded absolute path
  (`D:/springflow/springflow-react/src/springflow/generated`).
- The generated `SpringFlowClient` from the processor uses relative
  URLs; the React demo keeps a hand-maintained variant with a
  `BASE_URL` constant.
